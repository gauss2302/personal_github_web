...
const SignUpPage = () => {
  return (
    ...
    >
      <div
        className={
          "w-full rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 bg-glass"
        }
      >
        <div className={"p-6 space-y-4 md:space-y-6 sm:p-8"}>
          ...
          <p className={"text-gray-800"}>
            Sign up and unlock all the features of the app
            <span>
          ...
          <p className={"text-sm font-light text-gray-800"}>
            ...
            <Link
              to="/login"
              className={
                "font-medium text-primary-600 hover:underline text-blue-600"
              }
            >
              Login
            </Link>
